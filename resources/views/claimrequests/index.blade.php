...
@section('content')
    <h1 class="text-indigo-700 p-5 mg-10 font-bold text-5xl	">Claim Requests</h1>
                            ...
                            @if($claimRequests->count())
                              ...
                              <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                  <a href="/admin/requests/{{$request->id}}/approve" class="text-indigo-600 hover:text-indigo-900">Approve</a>
                                </td>
                              </tr>
                              @endforeach
                            @else
