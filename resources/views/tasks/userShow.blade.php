        ...
        <div class="">
            @if ($task->status == 'claimed')
                <div class="text-right">
                    <a href="/user/tasks/{{$task->id}}/submit" class=" border-2 font-bold border-indigo-700 px-5 py-2 rounded-lg text-indigo-700 hover:bg-indigo-700 hover:text-indigo-50 hover:shadow-md transition duration-300 ease-in-out"> Submit for Approval </a>
                </div>
            @else
                <div class="text-right">
                    <a href="/user/tasks/{{$task->id}}/claim" class=" border-2 font-bold border-indigo-700 px-5 py-2 rounded-lg text-indigo-700 hover:bg-indigo-700 hover:text-indigo-50 hover:shadow-md transition duration-300 ease-in-out"> Claim Task </a>
                </div>
            @endif
